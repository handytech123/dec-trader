...
import { assessMarketIntegrityBatch } from "./jupiter-token.js";
...
async function main(): Promise<void> {
  ...
  const results = await assessMarketIntegrityBatch(
    watchlist.assets
  ...
  try {
    ...
    await database.persistMarketIntegrity(assessedAt, results);
